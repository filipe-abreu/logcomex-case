...
//         params.codigo = this.filterCodigo
//       }
//       if (this.filterNome) {
//         params.nome = this.filterNome
//       }

//       axios.get('http://localhost/api/items', { params })
//         .then(response => {
//           this.items = response.data.data // Ajuste para Laravel com paginação
//         })
//         .catch(error => console.error('Erro ao buscar itens:', error))
//     },
//     clearFilters() {
//       this.filterCodigo = ''
//       this.filterNome = ''
//       this.fetchItems() // Recarrega os itens sem filtros
//     }
//   }
// }
</script>
